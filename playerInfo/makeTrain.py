...
batter_class_f = open('../clustering/clusterOutput/classification_batter_4.csv', mode='rt',newline='')#기존 train file 가져옴
batter_class_reader = list(csv.reader(batter_class_f))#타자 class dictionary
pitcher_class_f = open('../clustering/clusterOutput/classification_pitcher_4.csv', mode='rt',newline='')#기존 train file 가져옴
